                ...
                builder: (context, showHindi, _){
                  if(showHindi && _textController.text.isNotEmpty){
                    return Consumer(builder: (context, ref, _){
                      final translator = ref.watch(translateProvider(_textController.text));
            ...
            MaterialButton(
              ...
              onPressed: (){
                if(_formKey.currentState!.validate()){
                  ...
                  if(data == null){
                    ref.read(tcProvider.notifier).addNewTC(_textController.text);
                    Navigator.of(context).pop();
                  }else{
                    ref.read(tcProvider.notifier).editTC(data!.copyWith(value: _textController.text));
                    Navigator.of(context).pop();
                  }
                }
              },
